...
public class LessonController {
    ...
    public ResponseEntity<?> uploadPDF(
        ...
        try {
            ...
            lesson.setTitle("Bài học Kéo Thả: " + file.getOriginalFilename());
            ...
            // 🔥 BÍ KÍP MỚI: Dặn máy dịch là nếu AI có trả về dư biến nào không có trong class Question thì cứ lờ đi, đừng báo lỗi!
            ...
            // 🔥 SỬA LỖI POSTMAN BỊ NULL: Gắn danh sách câu hỏi ngược lại vào Bài học để nó in ra màn hình
