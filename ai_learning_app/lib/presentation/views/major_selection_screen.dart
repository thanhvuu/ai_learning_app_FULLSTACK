...
class _MajorSelectionScreenState extends State<MajorSelectionScreen> {
  ...
  Future<void> _selectMajor(String majorName) async {
    ...
    try {
      final String url =
          "${ApiConfig.users}/update-major?username=${widget.username}&major=${Uri.encodeComponent(majorName)}";
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (_) =>
                RoadmapScreen(username: widget.username, major: majorName),
          ),
        );
      } else {
          ...
          Column(
            children: [
              const Padding(
                ...
                child: Text(
                  "Hãy chọn chủ đề bạn quan tâm để bắt đầu lộ trình học tập riêng biệt của mình:",
