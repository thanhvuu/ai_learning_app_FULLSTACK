...
class _FillBlankScreenState extends State<FillBlankScreen> {
  ...
  bool _isCorrect(String? selected, QuestionModel q) {
    ...
    if (cleanCorrect == "a" &&
        cleanSelected == q.optionA.trim().toLowerCase()) {
      return true;
    }
    if (cleanCorrect == "b" &&
        cleanSelected == q.optionB.trim().toLowerCase()) {
      return true;
    }
    if (cleanCorrect == "c" &&
        cleanSelected == q.optionC.trim().toLowerCase()) {
      return true;
    }
    if (cleanCorrect == "d" &&
        cleanSelected == q.optionD.trim().toLowerCase()) {
      return true;
    }
